...
while True:
    ...
    if not calibrated:
        ...
        if absDiff / AvgRoi  > 0.1 or absDiffF / AvgRoiFilter  > 0.1:
            ...
            objectDetected = False
            #imgAct = None
        if absDiffDet / AvgRoiDet > 0.2 and calibrated:
            Process = True
    ...
    p1tmpDet = (RoiPosUL[0] + RoiOffsetDet, RoiPosUL[1])
    p2tmpDet = (RoiPosBR[0] + RoiOffsetDet, RoiPosBR[1])
    cv2.rectangle(GuiImage, p1tmpDet, p2tmpDet, (255, 255, 255), 2, 1)
